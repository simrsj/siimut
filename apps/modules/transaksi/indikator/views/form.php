...
<div class="row clearfix">
    ...
    <div class="col-sm-6">
        <?=form_label($form['target']['placeholder'], '', array('class' => '',));?>
        <div class="input-group">
            <div class="form-line">
                <?=form_input($form['target']);?>
            </div>
        </div>
        <?=form_error('target', '<div class="note">', '</div>');?>
    </div>
    <div class="col-sm-12">
        <?=form_label($form['formula']['placeholder'], '', array('class' => '',));?>
        <div class="input-group">
            <div class="form-line">
                <?=form_input($form['formula']);?>
            </div>
        </div>
        <?=form_error('formula', '<div class="note">', '</div>');?>
    </div>
    <div class="col-sm-6">
        <div class="input-group">
