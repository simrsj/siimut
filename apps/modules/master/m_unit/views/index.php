                    ...
                    <table class="table table-sm table-bordered table-hover dataTable">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 200px;text-align: center;">Nama Unit Pelayanan</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var orders = [[1, "asc"]];
        set_datatable('dataTable', "<?= site_url('m_unit/json_dgview'); ?>", column_list, column_def, null, orders);
    });
