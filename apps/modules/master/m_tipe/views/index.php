                    ...
                    <table class="table table-sm table-bordered table-hover dataTable">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">Tipe Indikator</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var orders = [[1, "asc"]];
        set_datatable('dataTable', "<?= site_url('m_tipe/json_dgview'); ?>", column_list, column_def, null, orders);
    });
