<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">SI IMUT</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="Indikator" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('user.index') }}">Prioritas</a>
                <a class="collapse-item" href="{{ route('user.index') }}">Corporate</a>
                <a class="collapse-item" href="{{ route('user.index') }}">Nasional</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
