...
class M_Rekening extends CI_Model {
    ...
    function tampil_detail(){
        ...
        $sql = "SELECT * FROM head_pengadaan a
                ...
                where b.id_uraian = ".$id." and a.tahun_anggaran =".$tahun;
    ...
    public function get_rekening_admin($jenis_belanja)
    {
        ...
        $tahun = $_SESSION['tahun'];
        $sql ="SELECT detail_pengadaan.id_uraian,uraian.kodering_uraian,uraian.nama_uraian
        , SUM(detail_pengadaan.total_harga) as total_anggaran
        FROM detail_pengadaan 
        JOIN head_pengadaan on detail_pengadaan.id_pengadaan = head_pengadaan.id_pengadaan
        JOIN users on head_pengadaan.id_user = users.id_user
        JOIN uraian on uraian.id_uraian = detail_pengadaan.id_uraian
        where detail_pengadaan.id_subkegiatan != 0 and detail_pengadaan.id_uraian != 0 and head_pengadaan.tahun_anggaran = '$tahun.'
        GROUP BY detail_pengadaan.id_uraian,uraian.kodering_uraian,uraian.nama_uraian";
