            ...
            <div class="col-md-12">
                <h3>Kegiatan 
                    ...
                    <?php if($this->session->userdata('role') == 'Admin'){ ?>     
                      <div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Tambah Kegiatan</a></div>
                    <?php } ?>
                </h3>
            </div>
            <hr/>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <div>
                      <button type="button" class="btn btn-secondary" data-dismiss="modal" aria-label="Close" name="btn-batal-kegiatan" id="btn-batal-kegiatan">
                      <!-- <span aria-hidden="true">&times;</span> -->
                      Batal
                      </button>
                      <button  type="submit" class="btn btn-success" name="submit" id="submit">Tambah Kegiatan</button> 
                    </div>
                  </div>
                  <div class="modal-body">
                          <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                <label class="col-md-12 col-form-label mini-text">Kodering Kegiatan</label>
                                <input type="text" name="kodering_kegiatan" id="kodering_kegiatan" class="form-control" placeholder="Kodering Kegiatan" required>
                              </div>
                              ...
                              <div class="col-md-4">
                                <label class="col-md-12 col-form-label mini-text">Program</label>
                                <select name="id_program" id="id_program" class="form-control js-data-example-basic-multiple" required></select> 
                            </div>
                  ...
                  <div class="modal-body">
                        ...
                        <div class="modal-body">
                          <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                <label class="col-md-12 col-form-label mini-text">Kodering Kegiatan</label>
                                <input type="hidden" name="e_id_kegiatan" id="e_id_kegiatan" class="form-control" placeholder="Kodering Kegiatan" required>
                                <input type="text" name="e_kodering_kegiatan" id="e_kodering_kegiatan" class="form-control" placeholder="Kodering Kegiatan" required>
                              </div>
                             
                              <div class="col-md-4">
                                <label class="col-md-12 col-form-label mini-text">Nama Kegiatan</label>
                                <input type="text" name="e_nama_kegiatan" id="e_nama_kegiatan" class="form-control" placeholder="Nama Kegiatan" required>
                              </div>
                              <div class="col-md-4">
                                <label class="col-md-12 col-form-label mini-text">Program</label>
                                <select name="e_id_program" id="e_id_program" class="form-control js-data-example-basic-multiple"  required></select> 
                            </div>
            ...
            <div class="modal fade" id="Modal_Delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                       Nama Kegiatan : <p id="text_kegiatan"></p>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" type="submit" id="btn_hapus_kegiatan" class="btn btn-primary">Ya</button>
                  </div>
                </div>
              </div>
            </div>
