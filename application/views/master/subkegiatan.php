        ...
        <div class="col-12">
            <div class="col-md-12">
                <h3>Subkegiatan
                    ...
                    <div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Tambah Subkegiatan</a></div>
                    <?php } ?>
                </h3>
            </div>
            <hr/>
                           
            <table class="table table-striped" id="SubkegiatanTable">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kegiatan</th>
                        <th>Kodering Subkegiatan</th>
...
<!--MODAL ADD-->
          <form id="form-tambah-subkegiatan" method="POST">            
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <div>
                      ...
                      <button  type="submit" class="btn btn-success" name="submit" id="submit">Tambah Subkegiatan</button> 
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                             ...
                             <div class="col-md-4">
                               <label class="col-md-12 col-form-label mini-text">Kodering Subkegiatan</label>
                               <input type="text" name="kodering_subkegiatan" id="kodering_subkegiatan" class="form-control" placeholder="Kodering Subkegiatan" required>
                             </div>
                            
                             <div class="col-md-4">
                               <label class="col-md-12 col-form-label mini-text">Nama Subkegiatan</label>
                               <input type="text" name="nama_subkegiatan" id="nama_subkegiatan" class="form-control" placeholder="Nama Subkegiatan" required>
                             </div>
                             <div class="col-md-4">
                               <label class="col-md-12 col-form-label mini-text">Kegiatan</label>
                               <select name="id_kegiatan" id="id_kegiatan" class="form-control js-data-example-basic-multiple" required></select> 
                           </div>
            ...
            <!--MODAL EDIT-->
            <form id="form-edit-subkegiatan">           
        <div class="modal fade" id="Modal_Edit"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Subkegiatan</h5>
                    <div>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" aria-label="Close" name="btn-batal-pengadaan" id="btn-batal-pengadaan">
                      <!-- <span aria-hidden="true">&times;</span> -->
                      Batal
                      </button>
                      <button  type="submit" class="btn btn-success" name="submit" id="submit">Tambah Subkegiatan</button>     </div>
                  </div>
                        <div class="modal-body">
                          <div class="form-group row">
                          <div class="col-md-4">
                               <label class="col-md-12 col-form-label mini-text">Kodering Subkegiatan</label>
                               <input type="hidden" name="e_id_subkegiatan" id="e_id_subkegiatan" class="form-control" required>
                               <input type="text" name="e_kodering_subkegiatan" id="e_kodering_subkegiatan" class="form-control" placeholder="Kodering subkegiatan" required>
                             </div>
                            
                             <div class="col-md-4">
                               <label class="col-md-12 col-form-label mini-text">Nama Subkegiatan</label>
                               <input type="text" name="e_nama_subkegiatan" id="e_nama_subkegiatan" class="form-control" placeholder="Nama subkegiatan" required>
                             </div>
                             <div class="col-md-4">
                               <label class="col-md-12 col-form-label mini-text">Kegiatan</label>
                               <select name="e_id_kegiatan" id="e_id_kegiatan" class="form-control js-data-example-basic-multiple" required></select> 
                           </div>
            ...
            <div class="modal fade" id="Modal_Delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                       Nama Subkegiatan : <p id="text_subkegiatan"></p>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" type="submit" id="btn_hapus_subkegiatan" class="btn btn-primary">Ya</button>
                  </div>
                </div>
              </div>
            </div>
