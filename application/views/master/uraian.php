        ...
        <div class="col-12">
            <div class="col-md-12">
                <h3>Uraian
                    ...
                    <div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Tambah Uraian</a></div>
                    <?php } ?>
                </h3>
            </div>
            <hr/>
                           
            <table class="table table-striped" id="UraianTable">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kodering Uraian</th>
                        <th>Nama Uraian</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
         ...
         <!--MODAL ADD-->
         <form id="form-tambah-uraian" method="POST">            
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <div>
                      ...
                      <button  type="submit" class="btn btn-success" name="submit" id="submit">Tambah Uraian</button> 
                    </div>
                  </div>
                  <div class="modal-body">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                <label class="col-md-12 col-form-label mini-text">Kodering Uraian</label>
                                <input type="text" name="kodering_uraian" id="kodering_uraian" class="form-control" placeholder="Kodering Uraian" required>
                              </div>
                             
                              <div class="col-md-6">
                                <label class="col-md-12 col-form-label mini-text">Nama Uraian</label>
                                <input type="text" name="nama_uraian" id="nama_uraian" class="form-control" placeholder="Nama Uraian" required>
                              </div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <div>
                      <button type="button" class="btn btn-secondary" data-dismiss="modal" aria-label="Close" name="btn-batal-uraian" id="btn-batal-uraian">
                      <!-- <span aria-hidden="true">&times;</span> -->
                      Batal
                      </button>
                      <button  type="submit" class="btn btn-success" name="submit" id="submit">Tambah Uraian</button> 
                  ...
                  <div class="modal-body">
                        ...
                        <div class="modal-body">
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <label class="col-md-12 col-form-label mini-text">Kodering Uraian</label>
                              <input type="hidden" name="e_id_uraian" id="e_id_uraian" class="form-control" placeholder="Kodering Uraian" required>                               
                              <input type="text" name="e_kodering_uraian" id="e_kodering_uraian" class="form-control" placeholder="Kodering Uraian" required>
                            </div>
                           
                            <div class="col-md-6">
                              <label class="col-md-12 col-form-label mini-text">Nama Uraian</label>
                              <input type="text" name="e_nama_uraian" id="e_nama_uraian" class="form-control" placeholder="Nama Uraian" required>
                            </div>
            ...
            <div class="modal fade" id="Modal_Delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                       Nama Uraian : <p id="text_uraian"></p>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" type="submit" id="btn_hapus_uraian" class="btn btn-primary">Ya</button>
                  </div>
                </div>
              </div>
            </div>
