...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        ptable = $('#PengadaanTable').DataTable( {
            ...
            //'serverSide'	: true,
            ajax:{
                url   : '<?php echo base_url('Pegawai/data_Pengadaan')?>',
        ...
        dpttable = $('#DetailPengadaantempTable').DataTable( {
            ...
            //'serverSide'	: true,
            ajax:{
                 url   : '<?php echo base_url('Pegawai/data_temp_pengadaan')?>',
                dataSrc : function(response){
                  var row = new Array();
                  //console.log()
                  var i = 1;
     ...
     dptable = $('#DetailPengadaanTable').DataTable( {
        ...
        $('#btn-save-pengadaan').on('click',function(){
            ...
            $.ajax({
                //type : "POST",
                url  : "<?php echo base_url('Pegawai/save_pengadaan')?>",
                dataType : "JSON",
    ...
    //                    show_brg_Pengadaan();
        ...
        //delete record to database
         $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('Pegawai/deletedetail')?>",
                dataType : "JSON",
                data : {id:id},
        ...
        function Edittemp(x){
            ...
            $.ajax({
                type:"POST",
                url  : "<?php echo base_url('Pegawai/get_id_temp')?>",
                dataType : "JSON",
                data : {id:id},
                        success: function(data){
                            //console.log(data);
    ...
    //              
        ...
        function Deletetemp(x){
            ...
            $.ajax({
                type:"POST",
                url  : "<?php echo base_url('Pegawai/DeleteTemp')?>",
                dataType : "JSON",
                data : {id:id},
                        success: function(data){
                            dpttable.ajax.reload(null,false);
        ...
        function BukaEdit(x){
                ...
                ajax:{
                    type:"POST",
                    url   : '<?php echo base_url('Pegawai/data_detail_pengadaan')?>',
                    data : {id:id},
                    dataSrc : function(response){
                        var row = new Array();
                        console.log(response);
        ...
        function EditPengadaan(x){
            ...
            $.ajax({
                type:"POST",
                url  : "<?php echo base_url('Pegawai/get_id_detail')?>",
                dataType : "JSON",
                data : {id:id},
                        success: function(data){
                            //console.log(data);
    ...
    //    console.log(id.value);
             $.ajax ({
                    type: 'POST',
                    url: '<?php echo base_url('Pegawai/ambil_kegiatan')?>',
                    dataType: 'json',
                    data : {id:id.value},
        ...
        function bukasubkegiatan(id){
             ...
             $.ajax ({
                    type: 'POST',
                    url: '<?php echo base_url('Pegawai/ambil_subkegiatan')?>',
                    dataType: 'json',
                    data : {id:id.value},
        ...
        function bukakegiatantemp(){
            //  console.log(id.value);
             $.ajax ({
                    type: 'POST',
                    url: '<?php echo base_url('Pegawai/ambil_kegiatantemp')?>',
                    dataType: 'json',
                    // data : {id:id.value},
        ...
        function bukasubkegiatantemp(){
            //  console.log(id.value);
             $.ajax ({
                    type: 'POST',
                    url: '<?php echo base_url('Pegawai/ambil_subkegiatantemp')?>',
                    dataType: 'json',
                    // data : {id:id.value},
        ...
        function ambilprogram(){
            $.ajax ({
                    // type: 'POST',
                    url: '<?php echo base_url('Pegawai/ambil_program')?>',
                    dataType: 'json',
                    success: function(response){
        ...
        function ambiluraian(){
            var id_jenis_belanja=0;
            $.ajax ({
                    type: 'POST',
                    url: '<?php echo base_url('Pegawai/ambil_uraian')?>',
                    dataType: 'json',
