...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        ptable = $('#PengadaanTable').DataTable( {
            ...
            //'serverSide'	: true,
            ajax:{
                url   : '<?php echo base_url('Pengadaan/data_Pengadaan')?>',
                    ...
                    if (hitung>0) {
                      for(var x in response.data){
                        ...
                        if(response.data[x].status == 1){
                            //<button onClick="CetakUsulan('+response.data[x].id_pengadaan+')" name="btn_cetak" class="btn btn-success btn-xs btn-flat"  title="Cetak Data"><i class="fas fa-print"></i></button> 
