<nav class="navbar navbar-expand navbar-dark static-top" style="background-color: gold;">
    <a class="navbar-brand mr-1" href="<?php echo base_url('Rkbu/Dashboard') ?>"><?php echo SITE_NAME ?></a>

    <button class="btn btn-link btn-sm order-1 order-sm-0 green-text" id="sidebarToggle" href="#">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false">
                <i class="fas fa-user-circle fa-fw green-text"></i> 
                <small class="green-text">Selamat Datang, </small>
                <span class="green-text"><?php echo "<b>".strtoupper($profile->unit_kerja)."</b>"; ?></span>
